...
class Application(Frame):
    ...
    def createWidget(self):
        ...
        self.rbman = Radiobutton(self,text="绑卡",variable=self.rbman_var,value=0,font=("黑体", 13))
        self.rbman.grid(row=7, column=0, padx=0, pady=0, columnspan=3)
        self.rbman = Radiobutton(self,text="改名",variable=self.rbman_var,value=1,font=("黑体", 13))
        ...
        self.start_btn.grid(row=9, column=0, padx=0, pady=10, columnspan=3)
        glv.set("start_btn", self.start_btn)

        # 显示日志滑动文本框(全局变量)
        self.text=scrolledtext.ScrolledText(self,width=75, height=23, bg="blue",fg="white", font=("黑体", 10))
        self.text.grid(row=10, column=0, padx=0, pady=10, columnspan=3)
